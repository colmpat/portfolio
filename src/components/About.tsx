  ...
  return (
    <div id="home" className="w-full flex space-between border-b pb-12">
      ...
      <div className="mt-20 flex flex-col w-2/3 gap-2">
        ...
        <h3 className="mt-1 text-3xl font-bold">and Computer Science Student @ <a href="https://www.usfca.edu/" rel="noreferrer" target="_blank" className="text-primaryPurple hover:underline">USF</a></h3>
      ...
      <div className="w-1/3 mt-10 px-10">
        <Image src="/images/colm-beach.jpeg" width={2801} height={3735} className="rounded-lg shadow-lg" alt="Colm Lang" />
      </div>
    </div>
  );
};
